...
<head>
    ...
    <style>
        .background {
            background-image: url("images/mainTextPicture/Gwangju_main.jpg");
	...
	<script type="text/javascript">
		window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
			var searchParam = "<%= request.getParameter("GwangjuTrable") %>";
...
<div id="wrapper">
    ...
    <div id="wrapper">
        ...
        <center>
            ...
            <header id="header">
                <div class="inner">
                    ...
                    <a href="main.jsp" class="logo">
							<span class="symbol"><img src="images/Symbols/gj.png" width=20% height=20% alt="" /></span>
                        <span class="title" style="color:white">Gwangju</span>
                    </a>
                </div>
            </header>
            ...
            <div id="main">
                <div class="inner">
                    <h1 style="color:white">광주</h1>
                    <br><br><br><br><br><br>
                    <a id="info" name="info"></a>
						<span class="image main"><img src="images/map/gwangju.gif" alt="광주 지역 지도" /></span>
                </div>
            </div>
        </center>
        ...
        <div class="firstBlock" style="float:left;">
            <img src="images/festival_picture/Gwangju_macju_festival.jpeg" width="300px" height="300px" >

            <div class="divStyle">
                <strong>비어 페스트 광주</strong><br>
            일시: 2023.08.09(수)~2023.08.12(토)<br>
            장소: 김대중컨벤션센터 전시장 및 야외광장<br>
            전화번호: 062-611-2162<br>
            입장료: 먹거리 등 유료<br>
            </div>

            <form class="formStyle" action="http://www.beerfestgwangju.com/" target="_blank">
        ...
        <div class="secondBlock">
            <img src="images/festival_picture/Gwangju_festival.jpeg" width="300px" height="300px">

            <div class="divStyle">
                <strong>광주세계김치축제</strong><br>
                일시: 2022.10.20(목)~2022.10.23(토)<br>
                장소: 광주광역시 남구 김치로 60<br>
                전화번호: 062-613-3955<br>
                입장료: 무료(일부 프로그램 유료)<br>
            </div>

            <form class="formStyle" action="https://kimchi.gwangju.go.kr/" target="_blank">
                <input type="submit" name="site" value="사이트 접속">
            </form>
        ...
        <center>
            ...
            <div id="main">
				...
				%>
					...
					<%
					// 검색 값 받아오기
					String result = request.getParameter("GwangjuTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from gwangju");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from gwangju where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM gwangju WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM gwangju WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM gwangju a JOIN gwangju b " +
				...
				<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
					...
					<ul>
						...
						<%
							String result2 = request.getParameter("GwangjuTrable");
