...
<head>
    ...
    <style>
        .background {
            background-image: url("images/mainTextPicture/Gwangwondo_main.png");
...
<script type="text/javascript">
    window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
        var searchParam = "<%= request.getParameter("GangwonTrable") %>";
...
<div id="wrapper">
    ...
    <div id="wrapper">
        ...
        <center>
            ...
            <header id="header">
                <div class="inner">
                    <a href="main.jsp" class="logo">
							<span class="symbol"><img src="images/Symbols/Gangwonsymbol.png" width=20% height=20%
                                                      alt="강원 로고"/></span>
                        <span class="title" style="color:white">Gangwon-do</span>
                    </a>
                </div>
            </header>
            ...
            <div id="main">
                <div class="inner">
                    <h1 style="color:white">강원도</h1>
                    <br><br><br><br><br><br>
                    <a id="info" name="info"></a>
                    <span class="image main"><img src="images/map/gw.png" alt="강원 지역 지도" width="50%"
                                                  height="50%"/></span>
                </div>
            </div>
        </center>
        ...
        <div class="firstBlock" style="float:left;">
            <img src="images/festival_picture/Gwangwon_dak_festival.jpeg" width="300px" height="300px" >

			<div class="divStyle">
				<strong>춘천 막국수 닭갈비 축제</strong><br>
				일시: 2023.06.13(화)~2023.06.18(일)<br>
				장소: 강원도 춘천시 스포츠타운길 245<br>
				전화번호: 033-254-4347<br>
				입장료: 무료(축제장 할인권 구매시 시내 제휴 음식점에서 할인혜택)<br>
			</div>

			<form class="formStyle" action="http://www.mdfestival.com/default/" target="_blank">
        ...
        <div class="secondBlock">
            <img src="images/festival_picture/Gwangwondo_festival.jpeg" width="300px" height="300px">

			<div class="divStyle">
				<strong>횡성한우축제</strong><br>
				일시: 2023.10.06(금)~2023.10.10(화)<br>
				장소: 강원도 횡성군 문화체육로 47 종합운동장<br>
				전화번호: 1522-1099<br>
				입장료: 무료<br>
			</div>

			<form class="formStyle" action="http://www.happyhanwoofestival.com/" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        ...
        <div class="thirdBlock" style="float: left;">
            <img src="images/festival_picture/Gwangwon_main_festival.jpeg" width="300px" height="300px">

			<div class="divStyle">
				<strong>춘천 마임축제</strong><br>
				일시: 2023.05.28(일)~2023.06.04(일)<br>
				장소: 강원도 춘천시 전역<br>
				전화번호: 033-242-0585<br>
				입장료: 일부 프로그램 유료/그 외 무료<br>
			</div>

			<form class="formStyle" action="http://mimefestival.com/" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        </div>
        ...
        <div class="fourthBlock" style="float:none;">
            <img src="images/festival_picture/Gwangwon_hangang_festival.png" width="300px" height="300px">

			<div class="divStyle">
				<strong>한강 낙동강 발원지 축제</strong><br>
				일시: 2022.07.29~2022.08.07<br>
				장소: 강원도 태백시 황지동 623<br>
				전화번호: 033-553-6900<br>
				입장료: 홈페이지 참조 <br>
			</div>

			<form class="formStyle" action="http://www.tbriverfestival.kr/" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        </div>
        ...
        <center>
            ...
            <div id="main">
				...
				%>
					...
					<%
					// 검색 값 받아오기
					String result = request.getParameter("GangwonTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from gangwon");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from gangwon where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM gangwon WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM gangwon WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM gangwon a JOIN gangwon b " +
						...
						if (rowCount == 4) {
							...
							if ("bridge".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM gyeongsang " +
										"WHERE tourist_type ='" + touristType + "' LIMIT 2");
								recommend_list4 = processJoinQuery(joinQuery4);
							...
							if ("field".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM gyeonggi " +
										"WHERE tourist_type ='park' LIMIT 3");
								recommend_list4 = processJoinQuery(joinQuery4);

							} else if ("island".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM gyeonggi " +
										"where local_name='광명시' or local_name='동두천시';");
								recommend_list4 = processJoinQuery(joinQuery4);

							}  else if ("valley".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM gyeonggi " +
										"where local_name='양주시' or local_name='파주시';");
								recommend_list4 = processJoinQuery(joinQuery4);
				...
				<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
					...
					<ul>
						...
						<%
							String result2 = request.getParameter("GangwonTrable");
