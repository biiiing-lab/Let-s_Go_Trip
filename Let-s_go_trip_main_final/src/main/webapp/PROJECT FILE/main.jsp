        ...
        <div class="inner">
            ...
            <section class="tiles">
                ...
                <article class="style1">
                    ...
                    <a href="Seoul.jsp" target="_blank"> <!-- 서울 페이지로 이동 -->
                        <h2>Seoul</h2>
                        <div class="content">
                            <p>동행 · 매력 특별시 서울 </p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Gyeonggi-do..jsp" target="_blank"> <!-- 경기 페이지로 이동 -->
                        <h2>Gyeonggi-do</h2>
                        <div class="content">
                ...
                <article class="style1">
                    ...
                    <a href="Incheon..jsp" target="_blank"> <!-- 인천 페이지로 이동 -->
                        <h2>Incheon</h2>
                        <div class="content">
                            <p>인천의 꿈, 대한민국의 미래</p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Gangwon-do.jsp" target="_blank"> <!-- 강원 페이지로 이동 -->
                        <h2>Gangwon-do</h2>
                        <div class="content">
                            <p>새로운 강원도! 특별 자치시대!</p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Chungcheong-do..jsp" target="_blank"> <!-- 충청 페이지로 이동 -->
                ...
                <article class="style1">
                    ...
                    <a href="Gyeongsang-do..jsp" target="_blank"> <!-- 경상 페이지로 이동 -->
                        <h2>Gyeongsang-do</h2>
                        <div class="content">
                ...
                <article class="style1">
                    ...
                    <a href="Daejeon.jsp" target="_blank"> <!-- 대전 페이지로 이동 -->
                        <h2>Daejeon</h2>
                        <div class="content">
                            <p>Daejeon is U</p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Jejudo.jsp" target="_blank"> <!-- 제주 페이지로 이동 -->
                        <h2>Jeju</h2>
                        <div class="content">
                            <p>소통으로 여는 행복한 제주시</p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Jeonla-do.jsp" target="_blank"> <!-- 전라 페이지로 이동 -->
                        <h2>jeonla-do</h2>
                        <div class="content">
                ...
                <article class="style1">
                    ...
                    <a href="Gwangju.jsp" target="_blank"> <!-- 광주 페이지로 이동 -->
                        <h2>Gwangju</h2>
                        <div class="content">
                            <p>희망도시 행복 광주</p>
                        </div>
                ...
                <article class="style1">
                    ...
                    <a href="Daegu..jsp" target="_blank"> <!-- 대구 페이지로 이동 -->
                        <h2>Daegu</h2>
                        <div class="content">
                ...
                <article class="style1">
                    ...
                    <a href="Ulsan_Busan.jsp" target="_blank"> <!-- 울부산 페이지로 이동 -->
                        <h2>Ulsan, Busan</h2>
                        <div class="content">
