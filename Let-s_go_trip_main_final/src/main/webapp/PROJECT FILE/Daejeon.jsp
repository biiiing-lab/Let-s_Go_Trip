...
<script type="text/javascript">
    window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
        var searchParam = "<%= request.getParameter("DaejeonTrable") %>";
...
<div id="wrapper">
    ...
    <div id="wrapper">
        ...
        <div class="firstBlock" style="float:left;">
            <img src="images/festival_picture/Deajun_music_festival.webp" width="300px" height="300px" >

			<div class="divStyle">
				<strong>대청호대덕뮤직페스티벌</strong><br>
				일시: 2023.04.08(토)~2023.04.09(일)<br>
				장소: 대청공원/대전광역시 대덕구 대전로 1033번길 20<br>
				전화번호: 042-608-6732<br>
				입장료: 무료<br>
			</div>

			<form class="formStyle" action="https://www.xn--vk1b9fv8tlkdzuqf4h.com/about-1" target="_blank">
        ...
        <div class="secondBlock">
            <img src="images/festival_picture/Daejeon_festival.jpeg" width="300px" height="300px">

			<div class="divStyle">
				<strong>유성온천문화축제</strong><br>
				일시: 2023.05.12(토)~2023.05.14(일)<br>
				장소: 대전광역시 유성구 봉명동 574<br>
				전화번호: 042-611-2080<br>
				입장료: 무료<br>
			</div>

			<form class="formStyle" action="https://www.yuseong.go.kr/prog/trrsrt/TRSE_01/tour/sub04_01/list.do" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        ...
        <center>
            ...
            <div id="main">
				...
				%>
					...
					<%
					// 검색 값 받아오기
					String result = request.getParameter("DaejeonTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from daejeon");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from daejeon where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM daejeon WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM daejeon WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM daejeon a JOIN daejeon b " +
						...
						if (recommend_list.isEmpty()) {
							...
							}  else if ("experience".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM chungcheong " +
				...
				<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
					...
					<ul>
						...
						<%
							String result2 = request.getParameter("DaejeonTrable");
