...
<head>
    ...
    <style>
        .background {
            background-image: url("images/mainTextPicture/Incheon_main.jpg");
	...
	<script type="text/javascript">
		window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
			var searchParam = "<%= request.getParameter("IncheonTrable") %>";
...
<div id="wrapper">
    ...
    <center>
        ...
        <header id="header">
            <div class="inner">
                ...
                <a href="main.jsp" class="logo">
						<span class="symbol"><img src="images/Symbols/iclogo.png" width=20% height=20% alt="" /></span>
                    <span class="title" style="color:white">Incheon</span>
                </a>
            </div>
        </header>
        ...
        <div id="main">
            <div class="inner">
                <h1 style="color:white">인천</h1>
                <br><br><br><br><br><br>
                <a id="Incheon" name="Incheon"></a>
                <span class="image main"><img src="images/map/ic.jpg" alt="인천 지역 지도"/></span>
            </div>
        </div>
    </center>
...
<div class="firstBlock" style="float:left;">
	<img src="images/festival_picture/incheon_pentaport_festival.jpeg" width="300px" height="300px" >

	<div class="divStyle">
		<strong>인천펜타포트 락 페스티벌</strong><br>
					일시: 2023.05.27(토)<br>
					장소: 이천문화예술회관 야외광장(남동구 예술로 149)<br>
					전화번호: 032-440-2199<br>
					입장료:무료<br>
	</div>

	<form class="formStyle" action="https://pentaport.co.kr/" target="_blank">
    ...
    <div class="thirdBlock" style="float: left;">
        <img src="images/festival_picture/incheon_festival.jpeg" width="300px" height="300px">
    
        <div class="divStyle">
            <strong>인천대공원 벚꽃축제</strong><br>
                        일시: 2023.04.08(토)~2023.04.09(일)<br>
                        장소: 인천광역시 남동구 장수동<br>
                        전화번호: 1544-7056<br>
                        입장료:무료<br>
        </div>
    
        <form class="formStyle" action="http://www.icbf.kr/" target="_blank">
            <input type="submit" name="site" value="사이트 접속">
        </form>
</div>
    ...
    <center>
        ...
        <div id="main">
            ...
            <div class="inner">
				...
				<%
					// 검색 값 받아오기f
					String result = request.getParameter("IncheonTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from incheon");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from incheon where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM incheon WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM incheon WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM incheon a JOIN incheon b " +
			...
			<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
				...
				<ul>
					...
					<%
						String result2 = request.getParameter("IncheonTrable");
