...
<head>
    ...
    <style>
        .background {
            background-image: url("images/mainTextPicture/Jeju_main.jpg");
	...
	<script type="text/javascript">
		window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
            var searchParam = "<%= request.getParameter("JejudoTrable") %>";
...
<div id="wrapper">
    ...
    <div id="wrapper">
        ...
        <center>
            ...
            <header id="header">
                <div class="inner">
                    ...
                    <a href="main.jsp" class="logo">
							<span class="symbol"><img src="images/Symbols/jeju.png" width=20% height=20%
                                                      alt=""/></span>
                        <span class="title" style="color:white">Jeju</span>
                    </a>
            ...
            <div id="main">
                <div class="inner">
                    <h1 style="color:white">제주</h1>
                    <br><br><br><br><br><br>
                    <a id="jeju" name="jeju"></a>
                    <span class="image main"><img src="images/map/jeju.jpg" alt="제주 지역 지도"/></span>
                </div>
            </div>
        </center>
        ...
        <div class="firstBlock" style="float:left;">
            <img src="images/festival_picture/jeju_fire_festival.jpeg" width="300px" height="300px" >

	<div class="divStyle">
		<strong>제주 들블축제</strong><br>
					일시: 2023.03.09(금)~2023.03.12(일)<br>
					장소: 제주 제주시 애월읍 봉성리 산59-8<br>
					전화번호: 064-728-2736<br>
					입장료:무료<br>
	</div>

	<form class="formStyle" action="https://www.jejusi.go.kr/buriburi/main.do" target="_blank">
        ...
        <div class="secondBlock">
            <img src="images/festival_picture/jeju_festival.jpeg" width="300px" height="300px">

	<div class="divStyle">
		<strong>제주 서귀포 유채꽃 축제</strong><br>
					일시: 2023.03.31(금)~2023.04.02(일)<br>
					장소: 제주특별자치도 서귀포시 녹산로 381-17<br>
					전화번호: 064-760-3942<br>
					입장료:무료<br>
	</div>

	<form class="formStyle" action="https://seogwipo.go.kr/festivals/uchae/index.htm" target="_blank">
		<input type="submit" name="site" value="사이트 접속">
	</form>
        ...
        <div class="thirdBlock" style="float: left;">
            <img src="images/festival_picture/jeju_sungsan_festival.png" width="300px" height="300px">

	<div class="divStyle">
		<strong>성산일출축제</strong><br>
					일시: 2022.12.31(토)~2023.01.01(일)<br>
					장소: 제주특별자치도 서귀포시 성산읍 일출로 284-12(성산읍)<br>
					전화번호: 064-782-2241<br>
					입장료:무료<br>
	</div>

	<form class="formStyle" action="https://www.sunrisefestival.kr/" target="_blank">
		<input type="submit" name="site" value="사이트 접속">
	</form>
        </div>
        ...
        <div class="fourthBlock" style="float:none;">
            <img src="images/festival_picture/jeju_animal_festival.jpeg" width="300px" height="300px">

	<div class="divStyle">
		<strong>제주반려동물 문화축제</strong><br>
					일시: 2023.05.27(토)<br>
					장소: 제주특별차지도 제주시 애월읍 봉성리 4554-12(새별오름주차장7)<br>
					전화번호: 064-710-2665<br>
					입장료:무료<br>
	</div>

	<form class="formStyle" action="https://www.jejufairs.com/" target="_blank">
		<input type="submit" name="site" value="사이트 접속">
	</form>
        </div>
        ...
        <center>
            ...
            <div id="main">
				...
				%>
					...
					<%
					// 검색 값 받아오기
					String result = request.getParameter("JejudoTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from jeju");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from jeju where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM jeju WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM jeju WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM jeju a JOIN jeju b " +
						...
						if (rowCount == 4) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM jeonla " +
										"WHERE tourist_type ='ocean' LIMIT 1");
								recommend_list4 = processJoinQuery(joinQuery4);

						} else if (rowCount == 2) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM jeonla " +
										"WHERE tourist_type ='park' LIMIT 2");
								recommend_list4 = processJoinQuery(joinQuery4);

						} else if(recommend_list.isEmpty()) {

							if ("arboretum".equals(touristType)) {
								joinQuery4 = stmt.executeQuery("SELECT tourist_spot, address FROM jeonla " +
				...
				<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
					...
					<ul>
						...
						<%
							String result2 = request.getParameter("JejudoTrable");
