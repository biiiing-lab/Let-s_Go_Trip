...
<head>
    ...
    <style>
        .background {
            background-image: url("images/mainTextPicture/Daegu_main.png");
    ...
    <script type="text/javascript">
		window.onload = function() { //페이지가 로드될 때 자동으로 실행되는 스크립트
			var searchParam = "<%= request.getParameter("DaeguTrable") %>";
...
<div id="wrapper">
    ...
    <div id="wrapper">
        ...
        <center>
            ...
            <header id="header">
                <div class="inner">
                    ...
                    <a href="main.jsp" class="logo">
							<span class="symbol"><img src="images/Symbols/daegu.png" width=20% height=20%
                                                      alt=""/></span>
                        <span class="title" style="color:white">Daegu</span>
                    </a>
                </div>
            </header>
            ...
            <div id="main">
                <div class="inner">
                    <h1 style="color:white">대구</h1>
                    <br><br><br><br><br><br>
                    <a id="info" name="info"></a>
                    <span class="image main"><img src="images/map/daegu.png" alt="대구 지역 지도" height="50%"
                                                  width="50%"/></span>
                </div>
            </div>
        </center>
        ...
        <div class="firstBlock" style="float:left;">
            <img src="images/festival_picture/Deagu_chimac_festival.jpeg" width="300px" height="300px">

			<div class="divStyle">
				<strong>대구치맥페스티벌</strong><br>
				일시: 2023.08.30(수)~2023.09.03(일)<br>
				장소: 대구광역시 달서구 공원순환로 36<br>
				전화번호: 053-248-9998<br>
				입장료: 무료<br>
			</div>

			<form class="formStyle" action="https://www.chimacfestival.com/index.php" target="_blank">
        ...
        <div class="secondBlock">
            <img src="images/festival_picture/Deagu_ttock_festival.jpeg" width="300px" height="300px">

			<div class="divStyle">
				<strong>떡볶이페스티벌</strong><br>
				일시: 2023.07.17(토)~2023.06.18(일)<br>
				장소: 대구광역시 북구 고성로 191<br>
				전화번호: 053-253-0515<br>
				입장료: 무료<br>
			</div>

			<form class="formStyle" action="https://tteokbokkifestival.com/" target="_blank">
				<input type="submit" name="site" value="사이트 접속"/>
			</form>
        ...
        <div class="thirdBlock" style="float: left;">
                       <img src="/images/festival_picture/Daegu_festival.png" width="300px" height="300px">

			<div class="divStyle">
				<strong>파워풀 대구 페스티벌</strong><br>
				일시: 2023.05.13(토)~2023.05.14(일)<br>
				장소: 대구광역시 중구 국채보상로<br>
				전화번호: 053-252-8370/053-252-8133<br>
				입장료: 부대행사(푸드존) 제외 이용요금 무료<br>
			</div>

			<form class="formStyle" action="https://www.pwf.or.kr/" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        </div>
        ...
        <div class="fourthBlock" style="float:none;">
            <img src="images/festival_picture/Deagu_Dimf_feastival.jpeg" width="300px" height="300px" >

			<div class="divStyle">
				<strong>대구 국제뮤지컬페스티벌</strong><br>
				일시: 2023.05.19(금)~2023.06.05(월)<br>
				장소: 대구 주요 공연장 및 시내 전역<br>
				전화번호: 053-622-1945<br>
				입장료: 각 프로그램별 상이<br>
			</div>

			<form class="formStyle" action="https://dimf.or.kr/main.do" target="_blank">
				<input type="submit" name="site" value="사이트 접속">
			</form>
        </div>
        ...
        <center>
            ...
            <div id="main">
				...
				%>
					...
					<%
					// 검색 값 받아오기
					String result = request.getParameter("DaeguTrable");
...
//					ArrayList<String> recommend_list = new ArrayList<String>();
					...
					try {
						...
						// db 연결
						Connection con = DriverManager.getConnection("jdbc:mysql://test.-.ap-northeast-2.rds.amazonaws.com:3306/travel?useSSL=false", "-", "-");
						Statement stmt = con.createStatement();

						// 서울 지역 row 가져오기
						check = stmt.executeQuery("select local_name from daegu");
						...
						// 쿼리 진행
						ResultSet rs = stmt.executeQuery("select address, tourist_spot from daegu where local_name = " + "\"" + query + "\"" + ";"); // 쿼리 연결
						...
						//특정 장소 종류 타입 저장
						ResultSet local_tourist_type = stmt.executeQuery("SELECT tourist_type FROM daegu WHERE local_name = '" + query + "'");
						String touristType = "";
						...
						//특정 장소 이름 저장
						ResultSet local = stmt.executeQuery("SELECT tourist_spot FROM daegu WHERE local_name = '" + query + "'");
						...
						ResultSet joinQuery = stmt.executeQuery("SELECT DISTINCT a.tourist_spot, a.address FROM daegu a JOIN daegu b " +
				...
				<div class="inner" style="border: #333333; width: 700px; height: 400px; float:right; position:relative; bottom:400px; right: 90px; text-align: left">
					...
					<ul>
						...
						<%
							String result2 = request.getParameter("DaeguTrable");
